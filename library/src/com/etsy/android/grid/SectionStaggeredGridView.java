 ...
 * <p/>
 * Builds multiple columns on top of {@link com.etsy.android.grid.ExtendableListView}
 * <p/>
 * Partly inspired by - https://github.com/huewu/PinterestLikeAdapterView
 */
public class SectionStaggeredGridView extends ExtendableListView {
    ...
    static class GridItemRecord implements Parcelable {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte((byte) (isSection ? 1 : 0));
        }
    ...
    public SectionStaggeredGridView(final Context context) {
        this(context, null);
    }

    public SectionStaggeredGridView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SectionStaggeredGridView(final Context context, final AttributeSet attrs, final int defStyle) {
